...
/**
 * Created by fish123 on 2016/12/9.
 */
public class CallPCA {
    public double[][] callPCA()
    {
        PCA test=new PCA();
        //原始数据
        ...
        System.out.println("假设阈值是90%，选取最大的前几个:");
